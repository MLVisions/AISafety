...
from .economic_models import MonteCarloPortfolioSimulator, create_default_investment_scenarios
from .historical_visualization import HistoricalDataVisualizationAgent
from .data_sources import fetch_market_data, get_all_asset_data
...
class PortfolioSimulationAgent:
    ...
    def __init__(self, output_dir: str = "src/data", random_seed: Optional[int] = 42):
        """
