...
from src.agents.utils.economic_models import MonteCarloPortfolioSimulator, create_default_investment_scenarios
...
from src.agents.utils.data_sources import DEFAULT_TICKERS, get_supported_tickers, analyze_data_availability
...
class TestEconomicModels:
    ...
    def test_calibration_with_mock_data(self):
        ...
        for asset, params in simulator.asset_params.items():
...
class TestPortfolioSimulationAgent:
    ...
    def test_csv_data_generation(self, mock_fetch):
        ...
        # Check structure
        assert 'Year' in csv_data.columns
        ...
        assert len(csv_data) == 4  # 2025-2028 for 3-year simulation
...
class TestDataSources:
    ...
    def test_analyze_data_availability_structure(self):
...
class TestInvestmentPipeline:
    ...
    def test_pipeline_integration(self, mock_fetch):
        ...
        assert len(csv_data) == 3  # 2025, 2026, 2027
...
class TestRiskMetrics:
    ...
    def test_confidence_intervals(self, sample_price_data):
    ...
    def test_success_probability(self, sample_price_data):
