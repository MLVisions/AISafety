...
Generative AI could expose **[300 million jobs](references.md#1)** worldwide *(Goldman Sachs, 2023)* and potentially displace around **[85 million roles](references.md#3)** within a few years *(WEF, 2023)*. Entry-level roles in programming, sales and accounting are already disappearing rapidly. As self-driving and retail automation spread, up to **[40% of jobs](references.md#4)** could be replaced *(PwC, 2024)*. Such displacement can trigger anxiety, depression and a crisis of identity for many workers.
